...
class Upnp():
    ...
    def add_port_mapping(self, local_ip):
        ...
        arguments = [
            ...
            ('NewPortMappingDescription', 'Maneframe Tensorflow'), # add a description
    ...
    def delete_port_mapping(self, local_ip):
        SSDP_ADDR = "239.255.255.250"
        SSDP_PORT = 1900
        SSDP_MX = 2
        SSDP_ST = "urn:schemas-upnp-org:device:InternetGatewayDevice:1"
        ...
        # create the function element and set its attribute
        fn = doc.createElementNS('', 'u:DeletePortMapping')
        fn.setAttribute('xmlns:u', 'urn:schemas-upnp-org:service:WANIPConnection:1')
